...
urlpatterns = [
    # localhost
    path('<str:customer_id>/&TotalCharges', views.Message, name='Message'), # 메일함(메인)
    path('<str:customer_id>/&tenure', views.Message, name='Message'),
    path('<str:customer_id>/&MultipleLines_Yes', views.Message, name='Message'),
