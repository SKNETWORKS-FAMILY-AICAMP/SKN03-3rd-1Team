...
5. Customer에 해당되는 위치를 점으로 나타내는 과정에서도 기존 템플릿 기능 중 차트 기능을 활용하려고 했으나, 점을 표현하는 과정에서 제대로 적용하지 못하고 해결이 되지 않아 기존에 사용했던 matplotlib을 이용하여 점을 찍어줌으로써 해결하였습니다.![alt text](image-2.png)
